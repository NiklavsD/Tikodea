      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-xl sm:text-2xl font-bold text-primary-600">Tikodea</h1>
            <button
              onClick={loadVideos}
              disabled={isLoading}
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 text-base border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600"
            />
          </div>
          ...
          <div className="flex items-center gap-2 mt-3 overflow-x-auto pb-2 scrollbar-hide">
            <button
              ...
              className={cn(
                'flex items-center gap-1.5 px-3 py-2 rounded-full text-sm whitespace-nowrap transition-colors min-h-[44px]',
                favoritesOnly
            ...
            {selectedTag && (
              <button
                ...
                className="px-3 py-2 bg-primary-100 text-primary-700 rounded-full text-sm flex items-center gap-1.5 min-h-[44px] whitespace-nowrap"
              >
                #{selectedTag}
            ...
            {allTags.slice(0, 5).map((tag) => (
              <button
                ...
                className={cn(
                  'px-3 py-2 rounded-full text-sm whitespace-nowrap transition-colors min-h-[44px]',
                  tag === selectedTag
